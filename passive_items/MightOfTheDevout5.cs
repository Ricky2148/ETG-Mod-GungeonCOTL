...
namespace GungeonCOTL.passive_items
{
    internal class MightOfTheDevout5 : TieredPassiveItem
    {
        ...
        private static float DamageStat = 1.5f;
        ...
        public static void Init()
        {
            ...
            string resourceName = "GungeonCOTL/Resources/passive_item_sprites/might_of_the_devout_5_pixelart_sprite";
            ...
            string longDesc = "1.5x damage\n" +
                "Insane strength of belief from your followers drastically increase your power.\n";
