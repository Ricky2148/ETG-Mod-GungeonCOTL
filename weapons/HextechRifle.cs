...
namespace LOLItems.weapons
{
    internal class HextechRifle : AdvancedGunBehavior
    {
        ...
        public static void Add()
        {
            ...
            gun.carryPixelOffset += new IntVector2(4, 2); //offset when holding gun vertically
            gun.carryPixelDownOffset += new IntVector2(0, -4); //offset when aiming down
            gun.carryPixelUpOffset += new IntVector2(-8, 0); //offset when aiming up
            ...
            gun.barrelOffset.transform.localPosition += new Vector3(16 / 16f, 7 / 16f);
            gun.gunScreenShake.magnitude = 1f; //How much the gun shakes the screen when fired.
             ...
             * Full list of IDs and names can be found here https://raw.githubusercontent.com/ModTheGungeon/ETGMod/master/Assembly-CSharp.Base.mm/Content/gungeon_id_map/items.txt
             * List of visual effects https://enterthegungeon.wiki.gg/wiki/Weapon_Visual_Effects */
            Projectile projectile = UnityEngine.Object.Instantiate<Projectile>((PickupObjectDatabase.GetById((int)Items.M1) as Gun).DefaultModule.projectiles[0]);
