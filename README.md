...
Aion Er'na (B):
- Stats: Fire rate: 0.5s, 15 dmg, 300 ammo
- Fires beads. Upon hitting an enemy, spreads out lightning to deal 30% of the original damage to nearby enemies.

![](https://i.ibb.co/ychrJKj1/vengencespear-idle-001.png)
Soul Spear (A):
