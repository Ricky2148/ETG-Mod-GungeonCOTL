...
The Collector (A):
- Stats: 1.1x DMG
- Effect: All bullets execute enemies below 5% max health. Executed enemies drop 1 extra casing.
...
Frozen Heart (B):
- Stats: 1 Armor
- Effect: Applies a 20% cripple to nearby enemies. Cripple: slows target's ROF by certain amount.
